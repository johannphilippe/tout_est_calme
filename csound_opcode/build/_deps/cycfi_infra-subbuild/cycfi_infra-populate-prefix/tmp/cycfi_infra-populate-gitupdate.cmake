...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "2024_MAY"
  WORKING_DIRECTORY "/home/johann/Documents/git/tout_est_calme/csound_opcode/build/_deps/cycfi_infra-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("2024_MAY" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/2024_MAY")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"2024_MAY\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/johann/Documents/git/tout_est_calme/csound_opcode/build/_deps/cycfi_infra-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/johann/Documents/git/tout_est_calme/csound_opcode/build/_deps/cycfi_infra-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
